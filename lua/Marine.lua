...
Script.Load("lua/ModelScaleMixin.lua")
...
Marine.kWalkMaxSpeed = 1.8                // Four miles an hour = 6,437 meters/hour = 1.8 meters/second (increase for FPS tastes)
Marine.kRunMaxSpeed = 4.4               // 10 miles an hour = 16,093 meters/hour = 4.4 meters/second (increase for FPS tastes)
Marine.kRunInfestationMaxSpeed = 4.4    // 10 miles an hour = 16,093 meters/hour = 4.4 meters/second (increase for FPS tastes)
...
//ExoFall additional functions
function Marine:GetControllerSize()
    return GetTraceCapsuleFromExtents(self:GetExtents() * kGameScale)
end
